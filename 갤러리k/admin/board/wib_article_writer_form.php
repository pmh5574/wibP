...
<form name="frmWrite" id="frmWrite" action="article_ps.php" method="post" enctype="multipart/form-data">
    ...
    <table class="table table-cols" id="board-table">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="urlLink"
                       value="<?= gd_isset($bdWrite['data']['address1']) ?>"
                       class="form-control">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" name="urlLink"
                       value="<?= gd_isset($bdWrite['data']['address2']) ?>"
                       class="form-control">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" name="urlLink"
                       value="<?= gd_isset($bdWrite['data']['district']) ?>"
                       class="form-control">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" name="urlLink"
                       value="<?= gd_isset($bdWrite['data']['country']) ?>"
                       class="form-control">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" name="urlLink"
                       value="<?= gd_isset($bdWrite['data']['postalCode']) ?>"
                       class="form-control">
            </td>
        </tr>
        <tr>
