        ...
        <table class="table table-cols">
            <tbody>
                <tr>
                    <th>네이버 경로</th>
                    <td>
                        <input type="text" name="naverURI" value="<?=$data['naverURI'];?>" class="form-control input-width js-maxlength">
                    </td>
                </tr>
                <tr>
                    <th>SSG 경로</th>
                    <td>
                        <input type="text" name="ssgURI" value="<?=$data['ssgURI'];?>" class="form-control input-width js-maxlength">
                    </td>
                </tr>
        </table>
    </div>
