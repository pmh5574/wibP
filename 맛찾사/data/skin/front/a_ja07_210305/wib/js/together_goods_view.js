...
var wib_goods_view = function() {
    ...
    this.input_count_change = function(inputName, goodsFl) {
        ...
        if (itemNo) {
            var optionDisplay = itemNo.toString().split(setIntDivision);
    ...
    this.option_price_display = function(inputName) {
        ...
        var frmId = "#" + $(inputName).closest("form").attr('id');
        var wibNum = frmId.split('#frmCheck');
        wibInit(wibNum[1]);
    ...
    this.remove_option = function(optionId) {
        ...
        $("#" + optionId).remove();
        if (typeof wib_total_calculate !== 'undefined' && $.isFunction(wib_total_calculate)) {
            wib_total_calculate(frmId);
        }
    ...
    this.remove_add_goods= function(optionId,addGoodsId) {
        ...
        var frmId = "#" + $("#add_goods_display_item_"+optionId+"_"+addGoodsId).closest("form").attr('id');
        ...
        if (typeof wib_total_calculate !== 'undefined' && $.isFunction(wib_total_calculate))   wib_total_calculate(frmId);
    }
