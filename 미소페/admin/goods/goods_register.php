    ...
    <div id="depth-toggle-layer-defaultInfo">
        <table class="table table-cols">
            ...
            <tr>
                <th>상품시즌</th>
                <?php
                $seasonDb = explode(",", $data['season']);
                $season = [];
                foreach ($seasonDb as $value) {
                    $season[$value] = $value;
                }
                ?>
                <td colspan="3">
                    <label class="checkbox-inline" title="S/S">
                        <input type="checkbox" name="season[]" value="S/S" <?=($season['S/S'])?'checked':''?> >S/S
                    </label>
                    <label class="checkbox-inline" title="F/W">
                        <input type="checkbox" name="season[]" value="F/W" <?=($season['F/W'])?'checked':''?> >F/W
                    </label>
                    <label class="checkbox-inline" title="봄">
                        <input type="checkbox" name="season[]" value="봄" <?=($season['봄'])?'checked':''?> >봄
                    </label>
                    <label class="checkbox-inline" title="여름">
                        <input type="checkbox" name="season[]" value="여름" <?=($season['여름'])?'checked':''?> >여름
                    </label>
                    <label class="checkbox-inline" title="가을">
                        <input type="checkbox" name="season[]" value="가을" <?=($season['가을'])?'checked':''?> >가을
                    </label>
                    <label class="checkbox-inline" title="겨울">
                        <input type="checkbox" name="season[]" value="겨울" <?=($season['겨울'])?'checked':''?> >겨울
                    </label>
                    <label class="checkbox-inline" title="사계절">
                        <input type="checkbox" name="season[]" value="사계절" <?=($season['사계절'])?'checked':''?> >사계절
                    </label>
                </td>
            </tr>
        </table>
