...
?>
<style>
    .orderGoodsDetail{min-width: 478px !important;}
    .wib-break{word-break: break-all;}
</style>
    ...
    <table class="table table-rows order-list">
        ...
        if (count($orderGridConfigList) > 0) {
            foreach($orderGridConfigList as $gridKey => $gridName){
                ...
                if($gridKey === 'userHandleDetailReason'){
                    $addClass = " class='orderGoodsDetail' ";
                }
                if($gridKey === 'check'){
                                ...
                                if (count($orderGridConfigList) > 0) {
                                    foreach($orderGridConfigList as $gridKey => $gridName){
                                        ...
                                        <?php if($gridKey === 'userHandleDetailReason') {// 상세사유?>
                                            <!--상세사유 추가-->
                                            <td class="text-left wib-break"><?= $val['userHandleDetailReason']; ?></td>         
                                        <?php } // 상세사유?>
