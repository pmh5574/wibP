            ...
            <td>
                <ul class="pdl0" id="uploadBox">
                    <li class="form-inline mgb5">
                        <input type="file" name="event_thumbnail" id="filestyle" tabindex="-1" style="position: absolute; clip: rect(0px, 0px, 0px, 0px);">
                        
                    </li>
                </ul>
                <?php if($data['event_thumbnail']){ ?>
                <div>
                    저장된 파일명:<?= $data['event_thumbnail']; ?>
                </div>
                <?php } ?>
                <div class="notice-danger">
                    이미지 크기는 다른 기획전 썸네일 이미지 크기와 동일하게 해주세요.
                </div>
                <div class="notice-info">
                    파일 업로드 최대 사이즈는 5M입니다.
                </div>
                </td>
        </tr>
        <tr>
