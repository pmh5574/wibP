...
// 검색 및 하단리스트용 엘리먼트 추가
function formSet(){
    if($('.layer_search_box form').length > 0){
        _forms = 'frmSearchTop';
        
    }else if($('.layer_search_content form').length > 0){
        _forms = 'layer_search_content';
    }
    ...
    $('#container #'+_forms).append(_addHtml).append(cateForm);
