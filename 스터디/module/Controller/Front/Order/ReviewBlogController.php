...
class ReviewBlogController extends \Controller\Front\Controller{
    public function index()
    {
        $conn = new WibSql();
        
        $reviewSql = "select * from morning_gcomment_blog_table";
        ...
        foreach ($reviewList as $value) {
            ...
            // 글제목
            $reviewTitle = ($urlLink)?'<a href="'.$urlLink.'" target="_blank"><img src="/mall/img/blog_view_btn.gif" style="width: 84px;display: block;"></a><div class="js_btn_view">'.$value['comment_subject'].'</div>':$value['comment_subject'];
