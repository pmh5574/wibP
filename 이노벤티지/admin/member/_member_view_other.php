...
<div class="form-inline">
    <table class="table table-cols">
        ...
        <tr>
            <th>이벤트 등<br/>프로모션 제공</th>
            <td>
                <?php
                if (isset($data['eventAgreeFl'])) {
                    
                    if($data['eventAgreeFl'] == 'y'){
                        echo '<div>- 이벤트 등 프로모션 제공에 대한 동의 : 동의함</div>';
                    } elseif ($data['eventAgreeFl'] == 'n') {
                        echo '<div>- 이벤트 등 프로모션 제공에 대한 동의 : 동의안함</div>';
                    }
