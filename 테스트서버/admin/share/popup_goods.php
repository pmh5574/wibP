...
<table cellpadding="0" cellspacing="0" width="100%" border="0" class="goodsChoice_outlineTable" style="margin-left:-10px;">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            //     var tblGoods = $('#iframe_goodsChoiceList').contents();
            //     console.log(tblGoods);
            //     var duplicateCnt = 0;
            //     var addCnt = 0;
            //     var registerCount = $('#tbl_add_goods_result').find('input[name="itemGoodsNo[]"]').length;
            //     var $this = this;
            //     console.log('asdasd');
            //     console.log(tblGoods.find('input[name="itemGoodsNo[]"]:checked'));
